...
export function CustomSelect({
 ...
 'focus:outline-none',
 selectedOption ? 'text-[#F5F2ED]' : 'text-[#F5F2ED]/20'
 )}
 >
 ...
 size={16}
 className={cn(
 'text-[#F5F2ED]/35 transition-transform duration-300',
 isOpen && 'rotate-180'
 )}
 />
 </button>
 ...
 'bg-[rgba(14,12,16,0.95)] backdrop-blur-[8px]',
 'border-[0.5px] border-[#F5F2ED]/[0.06] rounded-[12px]',
