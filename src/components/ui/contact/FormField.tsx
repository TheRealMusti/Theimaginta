...
export function FormField({
 ...
 'py-[14px] font-sans text-[15px] text-[#F5F2ED]',
 'placeholder:text-[#F5F2ED]/20',
 ...
 : 'top-[14px] text-[15px] text-[#F5F2ED]/35'
 )}
 >
 {label}
 </span>
 ...
 <span
 className="absolute right-0 top-[14px] text-[#C4A36E]/50 animate-in fade-in duration-300"
 aria-hidden="true"
 >
 <Check size={14} />
 </span>
 ...
 <span
 className="absolute right-0 bottom-[-22px] font-sans text-[10px] font-medium tracking-[0.16em] uppercase text-[#F5F2ED]/20"
 aria-hidden="true"
 >
