...
export function EasterEgg() {
 ...
 padding="40px"
 radius={24}
 className="max-w-[480px] w-full bg-[#0A0804]/80 border-[#F5F2ED]/10"
 >
 <p className="font-sans text-[17px] text-[#F5F2ED]/80 text-center leading-relaxed font-medium">
 You found it. We like curious people.<br />
 <span className="text-[#F5F2ED]">hello@imaginta.com</span>
 </p>
 </GlassPane>
 </motion.div>
 )}
