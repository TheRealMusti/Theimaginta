                        ...
                        <StaggerItem key={principle.num} className="h-full">
                            ...
                            >
                                ...
                                <div className="relative z-10 pr-[40px]">
                                    <h3 className="font-sans text-[18px] font-semibold text-white mb-[10px] relative inline-flex">
                                        {principle.title}
                                    </h3>
                                    <p className="font-sans text-[14px] font-normal text-white/[0.50] leading-[1.7]">
                                        {principle.desc}
                                    </p>
                                </div>
                            </GlassPane>
