                            ...
                            <ul className="flex flex-col gap-[14px]">
                                {GREAT_FIT.map((item, i) => (
                                    <li key={i} className="flex items-start gap-[12px]">
                                        ...
                                        <span className="font-sans text-[14px] font-normal text-white/[0.7] leading-[1.6]">{item}</span>
                                    </li>
                                ))}
                            </ul>
                        </GlassPane>
                    ...
                    <ScrollReveal delay={0.15} className="flex-1">
                        ...
                        >
                            ...
                            <ul className="flex flex-col gap-[14px]">
                                {NOT_FIT.map((item, i) => (
                                    <li key={i} className="flex items-start gap-[12px]">
                                        <div className="w-[4px] h-[4px] rounded-full bg-white/[0.15] shrink-0 mt-[8px]" />
                                        <span className="font-sans text-[14px] font-normal text-white/[0.35] leading-[1.6]">{item}</span>
                                    </li>
                                ))}
                            </ul>
                        </GlassPane>
