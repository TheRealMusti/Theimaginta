...
function WorkCard({ project, index }: { project: { title: string; category: string; year: string; tags: string[]; size: string; color: string; image: string; description?: string }; index: number }) {
