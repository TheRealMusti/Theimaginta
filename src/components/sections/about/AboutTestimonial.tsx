...
export function AboutTestimonial() {
 ...
 <GlassPane 
 padding="64px 40px" 
 className="w-full bg-accent-base/[0.03] border-accent-base/[0.1] text-center flex flex-col items-center relative overflow-hidden"
 ...
 <FadeUp delay={0.1}>
 <p className="font-sans text-[22px] md:text-[28px] font-medium tracking-tight text-[#F5F2ED] leading-[1.5] mb-[32px]">
 ...
 <span className="font-sans text-[16px] font-medium text-[#F5F2ED]">Sarah V.</span>
 <Meta className="text-[#F5F2ED]/[0.4]">FOUNDER (FINTECH)</Meta>
 </FadeUp>
 </div>
 </GlassPane>
 </ScaleReveal>
