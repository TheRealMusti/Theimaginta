        ...
        <section className="w-full py-[80px] relative z-10">
            ...
            <Container>
                ...
                <div className="flex flex-row justify-between items-end mb-[48px] relative z-10 w-full">
                    <Meta className="text-white/[0.3]">FOR YOUR BUSINESS</Meta>
                ...
                <StaggerGroup delay={0.2} className="flex flex-col relative z-10">
                    {ADVANTAGES.map((adv) => (
                        <StaggerItem key={adv.num}>
                            ...
                            >
                                {/* Bottom hairline */}
                                <div className="absolute bottom-0 left-0 w-full h-[0.5px] bg-white/[0.04] transition-colors duration-400 group-hover:bg-accent-base/[0.08]" />
                                
                                <div className="w-[48px] shrink-0">
                                    <Meta className="text-white/[0.3] transition-colors duration-400 group-hover:text-accent-base">{adv.num}</Meta>
                                </div>
                                <div className="w-full max-w-[280px] shrink-0 pr-[24px]">
                                    <h3 className="font-sans text-[20px] font-medium text-white">{adv.title}</h3>
                                </div>
                                <div className="flex-1">
                                    <p className="font-sans text-[14px] font-normal text-white/[0.55] leading-[1.7]">
                                        {adv.desc}
                                    </p>
                                </div>
                            </div>
