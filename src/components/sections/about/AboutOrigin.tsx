...
export function AboutOrigin() {
 ...
 <Meta className="text-[#F5F2ED]/[0.3]">BASED IN</Meta>
 <span className="font-sans text-[14px] font-medium text-[#F5F2ED]">Brussels, Belgium</span>
 </div>
 <div className="flex flex-col gap-[4px]">
 <Meta className="text-[#F5F2ED]/[0.3]">FOUNDED</Meta>
 <span className="font-sans text-[14px] font-medium text-[#F5F2ED]">2024</span>
 </div>
 <div className="flex flex-col gap-[4px]">
 <Meta className="text-[#F5F2ED]/[0.3]">FOCUS</Meta>
 <span className="font-sans text-[14px] font-medium text-[#F5F2ED]">SMEs & Startups</span>
 </div>
 </FadeUp>
 </div>
 ...
 <GlassPane 
 padding="40px" 
 className="h-full min-h-[400px] flex flex-col items-center justify-center text-center bg-accent-base/[0.02] border-accent-base/[0.06] relative overflow-hidden"
 >
 <motion.div 
 style={{ y: monogramY }} 
 ...
 <h3 className="font-sans text-[24px] font-medium text-[#F5F2ED] mb-[8px]">Mustafa</h3>
