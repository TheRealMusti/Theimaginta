...
export function AboutMetrics() {
 ...
 <GlassPane 
 padding="48px 40px" 
 className="w-full bg-accent-base/[0.03] border-accent-base/[0.1] "
 >
 ...
 <span className="font-sans text-[42px] font-semibold tracking-[-0.02em] text-[#F5F2ED] leading-none">
 <AnimatedNumber value={metric.number} />
 </span>
 <span className="font-sans text-[20px] font-medium text-[#F5F2ED]/[0.6]">{metric.suffix}</span>
 </div>
 <span className="font-sans text-[12px] font-medium tracking-[0.16em] uppercase text-[#F5F2ED]/[0.3] max-w-[180px]">
 {metric.context}
 </span>
 </div>
 ))}
 ...
 <Meta className="text-[#F5F2ED]/[0.4]">Numbers are nice. Work is better.</Meta>
 <Link 
 href="/work" 
 className="font-sans text-[14px] font-medium text-accent-base group flex items-center gap-[4px] transition-colors hover:text-[#F5F2ED]"
