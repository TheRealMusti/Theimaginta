...
export function AboutStudio() {
 ...
 <h2 className="font-sans text-[32px] font-semibold tracking-[-0.02em] text-[#F5F2ED] leading-[1.25]">
 ...
 <Meta className="mb-[4px] text-[#F5F2ED]/[0.3]">TIMEZONE</Meta>
 <span className="font-sans text-[14px] font-medium text-[#F5F2ED]">CET (UTC+1)</span>
 </div>
 <div className="hidden sm:block w-[0.5px] h-[24px] bg-[#F5F2ED]/[0.06]" />
 
 <div className="flex flex-col items-center text-center">
 <Meta className="mb-[4px] text-[#F5F2ED]/[0.3]">LANGUAGES</Meta>
 <span className="font-sans text-[14px] font-medium text-[#F5F2ED]">English · French · Arabic</span>
 </div>
 <div className="hidden sm:block w-[0.5px] h-[24px] bg-[#F5F2ED]/[0.06]" />
 
 <div className="flex flex-col items-center text-center">
 <Meta className="mb-[4px] text-[#F5F2ED]/[0.3]">MEETING</Meta>
 <span className="font-sans text-[14px] font-medium text-[#F5F2ED]">Video or in-person</span>
 </div>
 <div className="hidden sm:block w-[0.5px] h-[24px] bg-[#F5F2ED]/[0.06]" />
 
 <div className="flex flex-col items-center text-center">
 <Meta className="mb-[4px] text-[#F5F2ED]/[0.3]">COORDINATES</Meta>
 ...
 <GlassPane 
 padding="0" 
 className="w-full aspect-[21/9] max-h-[240px] bg-accent-base/[0.015] border-[#F5F2ED]/[0.06] shadow-none flex items-center justify-center relative overflow-hidden"
 ...
 <div className="w-[3px] h-[3px] rounded-full bg-[#F5F2ED] opacity-10" />
 </div>
