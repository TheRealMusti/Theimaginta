                ...
                <div className="flex flex-col items-center text-center max-w-[640px] mx-auto">
                    ...
                    <FadeUp delay={0.15}>
                        <MagneticButton>
                            <Link 
                                href="/contact" 
                                className="inline-flex items-center justify-center bg-white text-[#030303] px-[32px] py-[16px] rounded-pill font-sans text-[15px] font-medium tracking-[0.02em] transition-all duration-300 hover:bg-accent-base hover:text-[#030303] hover:shadow-[0_4px_32px_rgba(201,166,107,0.4)]"
