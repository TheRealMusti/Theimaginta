...
import { Container, Meta, Button, GlassPane, AmbientLighting, GrainOverlay } from '@/components/ui';
...
const USE_CASES: UseCaseData[] = [
 ...
 slug_full: 'corporate-wellness-iraq',
 ...
 slug_full: 'hotel-booking-conversion',
 ...
 slug_full: 'ai-fitness-intelligence',
...
export default function WorkPageContent() {
 ...
 <div ref={pageRef} className="relative w-full">
  ...
  <main id="main" className="w-full min-h-screen bg-[#060508] relative z-10 overflow-hidden">
  <GrainOverlay />
  
  {/* ── LARGE "CASES" BACKGROUND TEXT ── */}
  <motion.div
  className="hidden lg:block fixed right-[-5%] top-[15%] pointer-events-none z-0 select-none opacity-[0.015]"
  aria-hidden="true"
  ...
  <h1 className="mt-[24px] font-sans font-bold tracking-[-0.03em] text-[#F5F2ED]" style={{ fontSize: 'clamp(36px, 5.5vw, 64px)', lineHeight: 1.05 }}>
  What happens when the
  <br />
  <span className="italic text-[#F5F2ED]/50">right partner shows up.</span>
  </h1>

  <p className="mt-[24px] font-sans text-[18px] leading-[1.6] text-[#F5F2ED]/60 max-w-[520px]">
  ...
  >
  <h2 className="text-[clamp(28px,4vw,42px)] font-bold tracking-tight text-[#F5F2ED] relative z-10">
  Recognise your situation?
  </h2>
  <p className="mt-6 text-[18px] text-[#F5F2ED]/60 max-w-[480px] mx-auto relative z-10">
