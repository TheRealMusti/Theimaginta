...
import { BespokeGymDesign } from './BespokeGymDesign';
...
export function CaseStudyPage({ caseStudy }: CaseStudyPageProps) {
  // Bespoke Design Injection for Lifestyle Gym
  if (caseStudy.id === 'lifestyle-gym') {
    return <BespokeGymDesign caseStudy={caseStudy} />;
  }
 ...
 return (
 <div className="bg-[#060508] text-warm-white selection:bg-accent-base/30 selection:text-[#F5F2ED]">
 ...
 <div className="w-full h-full relative opacity-[0.015]">
 ...
 <Link 
 href="/work" 
 className="inline-block text-[13px] font-normal text-[#F5F2ED]/60 hover:text-warm-white transition-colors mb-8"
 >
 ← Back to Use Cases
 </Link>
 </FadeUp>
 ...
 <FadeUp delay={0.4}>
 <p className="font-sans italic text-[#F5F2ED]/60 mb-8" style={{ fontSize: 'clamp(18px, 2.5vw, 24px)' }}>
 {caseStudy.subtitle}
 </p>
 </FadeUp>

 <FadeUp delay={0.5}>
 <div className="flex flex-wrap items-center gap-4 text-[12px] font-bold tracking-widest text-[#F5F2ED]/20 uppercase">
 <span>{caseStudy.location}</span>
 <span className="text-[#F5F2ED]/10">·</span>
 ...
 <p className="mt-1 text-[12px] text-[#F5F2ED]/50 uppercase tracking-widest">{res.detail}</p>
 </div>
 ))}
 </GlassPane>
 </ScaleReveal>
 ...
 <p className="text-[17px] leading-[1.85] text-[#F5F2ED]/50">
 {p}
 </p>
 </ScrollReveal>
 ))}
 ...
 <p className="text-[20px] italic text-[#F5F2ED]/70 leading-[1.6]">
 ...
 <section className="relative py-24 bg-[#F5F2ED]/[0.01]">
 <SectionAtmosphere 
 number="02" 
 ...
 <p className="text-[17px] leading-[1.7] text-[#F5F2ED]/60">
 ...
 key={step.discipline}
 hover
 className="p-8 md:p-10 flex flex-col h-full bg-[#F5F2ED]/[0.02] border-[#F5F2ED]/[0.06]"
 >
 ...
 <p className="text-[14px] leading-[1.7] text-[#F5F2ED]/60 mb-8 flex-grow">
 {step.body}
 </p>
 ...
 <span 
 key={tag}
 className="px-2.5 py-1 rounded-full bg-[#F5F2ED]/[0.04] border border-[#F5F2ED]/[0.06] text-[9px] font-bold tracking-widest text-[#F5F2ED]/50 uppercase"
 >
 {tag}
 </span>
 ))}
 ...
 <div className="group py-12 border-b border-[#F5F2ED]/[0.06]">
 ...
 <span className="mt-1 text-[11px] font-bold tracking-widest text-[#F5F2ED]/20 uppercase whitespace-nowrap">
 {res.label}
 </span>
 </div>
 <p className="text-[15px] leading-relaxed text-[#F5F2ED]/50 group-hover:text-[#F5F2ED]/70 transition-colors duration-500">
 {res.narrative}
 </p>
 </div>
 </div>
 ...
 <p className="text-[20px] md:text-[24px] italic text-[#F5F2ED]/70 leading-[1.6] mb-8">
 ...
 <p className="mt-1 text-[11px] font-bold tracking-[0.2em] text-[#F5F2ED]/20 uppercase">
 ...
 <FadeUp>
 <GlassPane className="grid grid-cols-2 md:grid-cols-4 gap-8 p-10 bg-[#F5F2ED]/[0.02] border-[#F5F2ED]/[0.06]">
 <div>
 ...
 <GlassPane hover className="p-8 h-full bg-[#F5F2ED]/[0.02] border-[#F5F2ED]/[0.06] group-hover:border-accent-base/20">
 <Meta className="mb-2">PREVIOUS CASE STUDY</Meta>
 <div className="text-[16px] font-bold text-[#F5F2ED]/60 group-hover:text-warm-white transition-colors">
 ...
 <GlassPane hover className="p-8 h-full bg-[#F5F2ED]/[0.02] border-[#F5F2ED]/[0.06] group-hover:border-accent-base/20 text-right">
 ...
 <p className="text-[15px] text-[#F5F2ED]/60 mb-10">
