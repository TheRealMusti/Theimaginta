...
export default function ContactPage() {
    ...
    return (
        <main id="main" className="min-h-screen bg-[#030303] overflow-hidden">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-end">
                        <div className="relative z-10">
                            <ScrollReveal>
                                <div className="flex items-center gap-4 mb-10">
                                    ...
                                    <Meta className="m-0 text-accent-base uppercase tracking-[0.4em] font-bold text-[11px]">PROJECT INITIATION</Meta>
                                </div>
                                
                                <h1 className="text-6xl md:text-8xl font-bold text-white tracking-tighter leading-[0.9] mb-12">
                                    Tell us about <br />
                                    <span className="text-white/20 font-serif italic text-5xl md:text-7xl">your vision.</span>
                                </h1>
                                
                                <HydrationSafe fallback={<div className="h-4 w-48 opacity-0" />}>
                                    <div className="flex flex-col md:flex-row items-start md:items-center gap-8 text-white/40">
                                        <div className="flex items-center gap-3">
                                            <div className={cn(
                                                "w-2 h-2 rounded-full",
                                                studioStatus === 'online' ? "bg-emerald-500 shadow-[0_0_10px_rgba(16,185,129,0.4)]" : "bg-amber-500 shadow-[0_0_10px_rgba(245,158,11,0.4)]"
                                            )} />
                        ...
                        <div className="hidden lg:block">
                            <ScrollReveal delay={0.2}>
                                <div className="flex flex-col gap-2 p-10 border-l border-white/[0.05]">
                                    <span className="text-[10px] font-mono text-white/20 uppercase tracking-[0.4em] mb-4">Connection_Protocol</span>
                                    <p className="text-[16px] text-white/40 leading-relaxed font-light">
                ...
                <Container>
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                        ...
                        <div className="lg:col-span-8">
                            <ScrollReveal>
                                <div className="bg-white/[0.01] border border-white/[0.05] rounded-[40px] p-8 md:p-16 backdrop-blur-3xl relative overflow-hidden group/form">
                                    {/* Shimmer line */}
                                        ...
                                        <form onSubmit={handleSubmit} className="flex flex-col gap-12">
                                            <div className="flex items-center justify-between">
                                                <div className="flex flex-col gap-1">
                                                    <span className="text-[10px] font-mono text-white/20 uppercase tracking-[0.3em]">Module_ID</span>
                                                    <span className="text-[14px] font-bold text-white uppercase tracking-widest font-mono">BRIEF_COLLECTION_v3.0</span>
                                                </div>
                                                <div className="flex flex-col items-end gap-1">
                                                    <span className="text-[10px] font-mono text-white/20 uppercase tracking-[0.3em]">Validation</span>
                                                    <span className="text-[14px] font-bold text-accent-base uppercase tracking-widest font-mono">{completedFields} / 7</span>
                                                </div>
                                            </div>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                                                ...
                                                <div className="flex flex-col gap-3">
                                                    <span className="text-[10px] font-mono text-white/20 uppercase tracking-[0.3em]">Project_Nature</span>
                                                    <CustomSelect
                                                        id="service-select"
                                                        name="service"
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                                                <div className="flex flex-col gap-3">
                                                    <span className="text-[10px] font-mono text-white/20 uppercase tracking-[0.3em]">Capital_Allocation</span>
                                                    <CustomSelect
                                                        id="budget-select"
                                                        name="budget"
                                                ...
                                                <div className="flex flex-col gap-3">
                                                    <span className="text-[10px] font-mono text-white/20 uppercase tracking-[0.3em]">Temporal_Window</span>
                                                    <CustomSelect
                                                        id="timeline-select"
                                                        name="timeline"
                                            ...
                                            <div className="flex flex-col md:flex-row items-center justify-between gap-8 pt-8 border-t border-white/[0.05]">
                                                <p className="text-[11px] text-white/30 max-w-[300px]">
                                                ...
                                                <button
                                                    ...
                                                    className={cn(
                                                        "relative px-12 py-5 bg-accent-base text-black font-bold uppercase tracking-[0.2em] text-[12px] rounded-full overflow-hidden transition-all duration-700",
                                                        "hover:scale-[1.02] hover:shadow-[0_0_40px_rgba(201,166,107,0.3)] disabled:opacity-30 disabled:grayscale disabled:scale-100",
                        ...
                        <div className="lg:col-span-4 flex flex-col gap-6">
                            <ScrollReveal delay={0.2}>
                                <div className="p-10 bg-white/[0.01] border border-white/[0.05] rounded-[32px] flex flex-col gap-8 group hover:border-accent-base/20 transition-all duration-700">
                                    <div className="flex flex-col gap-1">
                                        <span className="text-[10px] font-mono text-white/20 uppercase tracking-[0.3em]">Communication_Bridge</span>
                                        <h4 className="text-xl font-bold text-white uppercase tracking-tighter">Direct Channels</h4>
                                    </div>
                                    
                                    <div className="flex flex-col gap-4">
                                        <a href="mailto:hello@imaginta.com" className="flex items-center justify-between group/link">
                                            <div className="flex items-center gap-4">
                                                <div className="w-10 h-10 rounded-xl bg-white/[0.02] border border-white/[0.05] flex items-center justify-center group-hover/link:border-accent-base/40 transition-all">
                                                    <Mail size={16} className="text-white/30 group-hover/link:text-accent-base" />
                                                </div>
                                                <span className="text-[14px] text-white/60 group-hover/link:text-white transition-colors">hello@imaginta.com</span>
                                            </div>
                                            <ArrowUpRight size={14} className="text-white/10 group-hover/link:text-accent-base" />
                                        </a>
                                        <a href="https://cal.com/imaginta" target="_blank" className="flex items-center justify-between group/link">
                                            <div className="flex items-center gap-4">
                                                <div className="w-10 h-10 rounded-xl bg-white/[0.02] border border-white/[0.05] flex items-center justify-center group-hover/link:border-accent-base/40 transition-all">
                                                    <Calendar size={16} className="text-white/30 group-hover/link:text-accent-base" />
                                                </div>
                                                <span className="text-[14px] text-white/60 group-hover/link:text-white transition-colors">Schedule Call</span>
                                            </div>
                                            <ArrowUpRight size={14} className="text-white/10 group-hover/link:text-accent-base" />
                                        </a>
                                    </div>
                            ...
                            <ScrollReveal delay={0.4}>
                                <div className="p-10 bg-white/[0.01] border border-white/[0.05] rounded-[32px] flex flex-col gap-6">
                                    <div className="flex flex-col gap-1">
                                        <span className="text-[10px] font-mono text-white/20 uppercase tracking-[0.3em]">Studio_Presence</span>
                                        <h4 className="text-xl font-bold text-white uppercase tracking-tighter">Brussels, BE</h4>
                                    </div>
                                    <div className="flex flex-col gap-3">
                ...
                <Container className="max-w-4xl">
                    <ScrollReveal>
                        <div className="text-center mb-20">
                            ...
                            <h2 className="text-4xl md:text-5xl font-bold text-white tracking-tighter">Frequently Asked</h2>
                        </div>
                    </ScrollReveal>

                    <ScrollReveal delay={0.2}>
                        <div className="bg-white/[0.01] border border-white/[0.05] rounded-[40px] p-8 md:p-12 backdrop-blur-2xl">
            ...
            <section className="py-32 text-center">
                <Container>
                    <ScrollReveal>
                        <span className="text-5xl md:text-7xl font-bold text-white/10 tracking-tighter hover:text-accent-base/40 transition-all duration-1000 cursor-default select-none">
                            IMAGINTA.
                        </span>
                        <p className="mt-8 text-[14px] italic text-white/20 font-serif">
