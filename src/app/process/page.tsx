...
import { Container, Meta, AmbientLighting, GrainOverlay } from '@/components/ui';
  ...
  return (
    <div ref={pageRef} className="relative w-full">
      <AmbientLighting 
        pageRef={pageRef}
        keyLight={{
          gradient: "radial-gradient(ellipse 55% 45% at 50% 20%, rgba(201,166,107,0.025), transparent 70%)",
          speed: 0.97
        }}
        fillLight={{
          gradient: "radial-gradient(ellipse 45% 40% at 75% 55%, rgba(201,166,107,0.015), transparent 70%)",
          speed: 0.93
        }}
        accentLight={{
          gradient: "radial-gradient(ellipse 35% 30% at 30% 85%, rgba(201,166,107,0.012), transparent 65%)",
          speed: 0.88
        }}
      />

      <main className="w-full min-h-screen bg-void text-[#F5F2ED] relative z-10 overflow-hidden selection:bg-accent-base/30">
        <GrainOverlay />
        ...
        <ScaleReveal>
            ...
            <Container>
              ...
              <FadeUp delay={0.15} className="flex items-center justify-between">
                <div className="flex items-center gap-[8px]">
                  ...
                  <Meta className="text-[#F5F2ED]/[0.2]">/</Meta>
              ...
              <FadeUp delay={0.3} className="mt-[48px]">
                <h1 className="font-sans text-[clamp(40px,6vw,72px)] leading-[1.05] font-bold tracking-[-0.04em] text-[#F5F2ED]">
                  How we bring<br />
                  <span className="font-normal italic text-[#F5F2ED]/[0.50]">ideas to life.</span>
                </h1>
              </FadeUp>

              {/* Row 3 - Description */}
              <FadeUp delay={0.45} className="mt-[28px] max-w-[580px]">
                <p className="font-sans text-[17px] font-normal text-[#F5F2ED]/[0.72] leading-[1.7]">
              ...
              <FadeUp delay={0.6} className="mt-[40px] flex items-center gap-[12px] flex-wrap">
                ...
                <Meta className="!text-[11px] text-[#F5F2ED]/[0.30]">·</Meta>
          ...
          <ProcessJourney>
            {/* PHASE 01: INTRO */}
            <PhaseAtmosphere id="intro" number="01" className="scroll-mt-[96px]">
              <Container className="pt-[100px] pb-[80px]">
                ...
                <FadeUp delay={0.1} className="pl-0 md:pl-[120px]">
                  ...
                  <h2 className="font-sans text-[40px] font-bold tracking-[-0.03em] text-[#F5F2ED] mt-[8px]">The Intro</h2>
                  <p className="font-sans text-[18px] font-normal italic text-[#F5F2ED]/[0.50] mt-[8px]">We start before the contract.</p>
                </FadeUp>
                ...
                <div className="mt-[40px] pl-0 md:pl-[120px] flex flex-col md:flex-row gap-[48px]">
                  ...
                  <FadeUp delay={0.3} className="flex-1 md:flex-[1.2]">
                    <p className="font-sans text-[16px] font-normal text-[#F5F2ED]/[0.72] leading-[1.8] mb-[20px]">
                    ...
                    <p className="font-sans text-[16px] font-normal text-[#F5F2ED]/[0.72] leading-[1.8]">
                    ...
                    <div className="mt-[32px] pt-[24px] border-t border-accent-base/10 flex flex-col gap-[12px]">
                      <div className="flex items-center gap-[12px]">
                        <Meta className="w-[140px] text-[#F5F2ED]/[0.30]">TYPICAL DURATION</Meta>
                        <span className="font-sans text-[14px] font-medium text-[#F5F2ED]">1–2 conversations</span>
                      </div>
                      <div className="flex items-center gap-[12px]">
                        <Meta className="w-[140px] text-[#F5F2ED]/[0.30]">YOUR COMMITMENT</Meta>
                        <span className="font-sans text-[14px] font-medium text-[#F5F2ED]">30 minutes</span>
                      </div>
                    </div>
                  </FadeUp>
                  ...
                  <ScrollReveal delay={0.4} className="flex-1">
                    <div className="p-[32px] rounded-[32px] bg-accent-base/[0.02] border border-accent-base/[0.1] h-full" data-cursor="PHASE · 01">
                      <h3 className="font-sans text-[16px] font-medium text-[#F5F2ED] mb-[24px]">What happens</h3>
                      <ul className="flex flex-col gap-[12px]">
                        {[
                          ...
                          <li key={i} className="flex items-start gap-[12px]">
                            ...
                            <span className="font-sans text-[14px] font-normal text-[#F5F2ED]/[0.55] leading-[1.7]">
                              {item}
                            </span>
                          </li>
                        ))}
            ...
            {/* PHASE 02: DISCOVERY */}
            <PhaseAtmosphere id="discovery" number="02" className="scroll-mt-[96px] mt-[40px]">
              <div className="w-full h-px bg-[linear-gradient(90deg,transparent_10%,rgba(201,166,107,0.06)_50%,transparent_90%)] mb-[80px]" />
              <Container className="pb-[80px]">
                {/* PHASE HEADER */}
                <PhaseNode className="top-0" />
                <FadeUp delay={0.1} className="pl-0 md:pl-[120px]">
                  <Meta className="text-accent-base">02</Meta>
                  <h2 className="font-sans text-[40px] font-bold tracking-[-0.03em] text-[#F5F2ED] mt-[8px]">Discovery</h2>
                  <p className="font-sans text-[18px] font-normal italic text-[#F5F2ED]/[0.50] mt-[8px]">We listen before we design.</p>
                </FadeUp>
                ...
                <div className="mt-[40px] pl-0 md:pl-[120px] flex flex-col-reverse md:flex-row gap-[48px]">
                  ...
                  <ScrollReveal delay={0.3} className="flex-1">
                    <div className="p-[32px] rounded-[32px] bg-accent-base/[0.02] border border-accent-base/[0.1] h-full" data-cursor="PHASE · 02">
                      <h3 className="font-sans text-[16px] font-medium text-[#F5F2ED] mb-[24px]">What we explore</h3>
                      <ul className="flex flex-col gap-[12px]">
                        {[
                  ...
                  <FadeUp delay={0.4} className="flex-1 md:flex-[1.2]">
                    ...
                    <div className="mt-[32px] pt-[24px] border-t border-accent-base/10 flex flex-col gap-[12px]">
                      <div className="flex items-center gap-[12px]">
                        <Meta className="w-[140px] text-[#F5F2ED]/[0.30]">DURATION</Meta>
                        <span className="font-sans text-[14px] font-medium text-[#F5F2ED]">1–2 weeks</span>
                      </div>
                      <div className="flex items-center gap-[12px]">
                        <Meta className="w-[140px] text-[#F5F2ED]/[0.30]">DELIVERABLES</Meta>
                        <span className="font-sans text-[14px] font-medium text-[#F5F2ED]">Research report, insights deck, project brief</span>
                      </div>
                      <div className="flex items-center gap-[12px]">
                        <Meta className="w-[140px] text-[#F5F2ED]/[0.30]">YOUR COMMITMENT</Meta>
                        <span className="font-sans text-[14px] font-medium text-[#F5F2ED]">3–4 hours total</span>
                      </div>
                    </div>
                  </FadeUp>
                </div>
            ...
            <PhaseAtmosphere id="strategy-design" number="03" className="scroll-mt-[96px] mt-[40px]">
              <div className="w-full h-px bg-[linear-gradient(90deg,transparent_10%,rgba(201,166,107,0.06)_50%,transparent_90%)] mb-[80px]" />
              <Container className="pb-[80px]">
                {/* PHASE HEADER */}
                <PhaseNode className="top-0" />
                <FadeUp delay={0.1} className="pl-0 md:pl-[120px]">
                  ...
                  <h2 className="font-sans text-[40px] font-bold tracking-[-0.03em] text-[#F5F2ED] mt-[8px]">Strategy &amp; Design</h2>
                  <p className="font-sans text-[18px] font-normal italic text-[#F5F2ED]/[0.50] mt-[8px]">From abstraction to architecture.</p>
                </FadeUp>
                ...
                <div className="mt-[40px] pl-0 md:pl-[120px]">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-[24px]">
                    <ScrollReveal delay={0.4}>
                      <div className="p-[32px] rounded-[32px] bg-[#F5F2ED]/[0.01] border border-[#F5F2ED]/[0.06] h-full" data-cursor="UX · ARCHITECTURE">
                        <h3 className="font-sans text-[18px] font-medium text-[#F5F2ED] mb-[8px]">Architecture &amp; UX</h3>
                        <p className="font-sans text-[14px] font-normal text-[#F5F2ED]/[0.55] mb-[24px] leading-[1.6]">
                        ...
                        <ul className="flex flex-col gap-[12px]">
                          {["Wireframes & Prototypes", "User flows & Edge cases", "API design & Schemas", "Data mapping"].map((item, i) => (
                            <li key={i} className="flex items-start gap-[12px]">
                              <div className="w-[4px] h-[4px] rounded-full bg-[#F5F2ED]/20 shrink-0 mt-[10px]" />
                              <span className="font-sans text-[14px] font-normal text-[#F5F2ED]/[0.55] leading-[1.7]">{item}</span>
                            </li>
                          ))}
                        </ul>
                      </div>
                    ...
                    <ScrollReveal delay={0.5}>
                      <div className="p-[32px] rounded-[32px] bg-[#F5F2ED]/[0.01] border border-[#F5F2ED]/[0.06] h-full" data-cursor="UI · MOTION">
                        <h3 className="font-sans text-[18px] font-medium text-[#F5F2ED] mb-[8px]">Visual Design</h3>
                        <p className="font-sans text-[14px] font-normal text-[#F5F2ED]/[0.55] mb-[24px] leading-[1.6]">
                  ...
                  <FadeUp delay={0.6} className="mt-[24px]">
                    <div className="p-[32px] md:p-[40px] rounded-[32px] bg-accent-base/[0.02] border border-accent-base/[0.1] relative overflow-hidden">
                      ...
                      <div className="relative z-10 flex flex-col md:flex-row gap-[32px] md:items-center justify-between">
                        <div className="max-w-[480px]">
                          ...
                          <p className="font-sans text-[16px] font-normal text-[#F5F2ED]/[0.65] leading-[1.7]">
                        ...
                        <div className="flex flex-col gap-[16px] shrink-0">
                          <div className="flex items-center gap-[12px]">
                            <Meta className="w-[100px] text-[#F5F2ED]/[0.30]">DURATION</Meta>
                            <span className="font-sans text-[14px] font-medium text-[#F5F2ED]">2–4 weeks</span>
                          </div>
                          <div className="flex items-center gap-[12px]">
                            <Meta className="w-[100px] text-[#F5F2ED]/[0.30]">COMMITMENT</Meta>
                            <span className="font-sans text-[14px] font-medium text-[#F5F2ED]">1–2 hrs / week</span>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            {/* PHASE 04: BUILD */}
            <PhaseAtmosphere id="build" number="04" className="scroll-mt-[96px] mt-[40px]">
              <div className="w-full h-px bg-[linear-gradient(90deg,transparent_10%,rgba(201,166,107,0.06)_50%,transparent_90%)] mb-[80px]" />
              <Container className="pb-[80px]">
                {/* PHASE HEADER */}
                <PhaseNode className="top-0" />
                <FadeUp delay={0.1} className="pl-0 md:pl-[120px]">
                  ...
                  <h2 className="font-sans text-[40px] font-bold tracking-[-0.03em] text-[#F5F2ED] mt-[8px]">Build</h2>
                  <p className="font-sans text-[18px] font-normal italic text-[#F5F2ED]/[0.50] mt-[8px]">Speed. Precision. Momentum.</p>
                </FadeUp>

                {/* CONTENT */}
                <div className="mt-[40px] pl-0 md:pl-[120px] flex flex-col-reverse md:flex-row gap-[48px]">
                  {/* LEFT - Sprints Visualization */}
                  <ScrollReveal delay={0.3} className="flex-1 border-l border-[#F5F2ED]/[0.06] pl-[24px] md:pl-[32px] py-[12px] flex flex-col gap-[32px]">
                    {[
                      ...
                      <div key={i} className="relative group">
                        {/* Step dot */}
                        <div className={`absolute -left-[28.5px] md:-left-[36.5px] top-[6px] w-[9px] h-[9px] rounded-full transition-colors duration-500 ${sprint.active ? 'bg-accent-base ' : 'bg-[#F5F2ED]/[0.1] group-hover:bg-[#F5F2ED]/[0.3]'}`} />
                        
                        <Meta className={sprint.active ? 'text-accent-base' : 'text-[#F5F2ED]/[0.4]'}>{sprint.sprint}</Meta>
                        <h3 className="font-sans text-[16px] font-medium text-[#F5F2ED] mt-[4px] mb-[8px]">{sprint.title}</h3>
                        <p className="font-sans text-[14px] font-normal text-[#F5F2ED]/[0.55] leading-[1.6]">
                          {sprint.desc}
                        </p>
                      </div>
                    ))}
                  ...
                  <FadeUp delay={0.4} className="flex-1 md:flex-[1.2]">
                    ...
                    <div className="mt-[32px] pt-[24px] border-t border-accent-base/10 flex flex-col gap-[12px]">
                      <div className="flex items-center gap-[12px]">
                        <Meta className="w-[140px] text-[#F5F2ED]/[0.30]">DURATION</Meta>
                        <span className="font-sans text-[14px] font-medium text-[#F5F2ED]">4–12 weeks</span>
                      </div>
                      <div className="flex items-center gap-[12px]">
                        <Meta className="w-[140px] text-[#F5F2ED]/[0.30]">DELIVERABLES</Meta>
                        <span className="font-sans text-[14px] font-medium text-[#F5F2ED]">Staging environments, source code</span>
                      </div>
                      <div className="flex items-center gap-[12px]">
                        <Meta className="w-[140px] text-[#F5F2ED]/[0.30]">YOUR COMMITMENT</Meta>
                        <span className="font-sans text-[14px] font-medium text-[#F5F2ED]">1 hr / sprint</span>
                      </div>
                    </div>
                  </FadeUp>
                </div>
            ...
            {/* PHASE 05: LAUNCH */}
            <PhaseAtmosphere id="launch" number="05" className="scroll-mt-[96px] mt-[40px]">
              <div className="w-full h-px bg-[linear-gradient(90deg,transparent_10%,rgba(201,166,107,0.06)_50%,transparent_90%)] mb-[80px]" />
              <Container className="pb-[80px]">
                {/* PHASE HEADER */}
                <PhaseNode className="top-0" />
                <FadeUp delay={0.1} className="pl-0 md:pl-[120px]">
                  ...
                  <h2 className="font-sans text-[40px] font-bold tracking-[-0.03em] text-[#F5F2ED] mt-[8px]">Launch</h2>
                  <p className="font-sans text-[18px] font-normal italic text-[#F5F2ED]/[0.50] mt-[8px]">No loose ends.</p>
                </FadeUp>
                ...
                <div className="mt-[40px] pl-0 md:pl-[120px] flex flex-col md:flex-row gap-[48px]">
                  ...
                  <FadeUp delay={0.3} className="flex-1 md:flex-[1.2]">
                    ...
                    <div className="mt-[32px] pt-[24px] border-t border-accent-base/10 flex flex-col gap-[12px]">
                      <div className="flex items-center gap-[12px]">
                        <Meta className="w-[140px] text-[#F5F2ED]/[0.30]">DURATION</Meta>
                        <span className="font-sans text-[14px] font-medium text-[#F5F2ED]">1 week</span>
                      </div>
                      <div className="flex items-center gap-[12px]">
                        <Meta className="w-[140px] text-[#F5F2ED]/[0.30]">DELIVERABLES</Meta>
                        <span className="font-sans text-[14px] font-medium text-[#F5F2ED]">Live product, codebase handover, admin training</span>
                      </div>
                    </div>
                  </FadeUp>
                  ...
                  {/* RIGHT - Checkboxes */}
                  <ScrollReveal delay={0.4} className="flex-1">
                    <div className="p-[32px] rounded-[32px] bg-accent-base/[0.02] border border-accent-base/[0.1] h-full" data-cursor="CHECKLIST">
                      <h3 className="font-sans text-[16px] font-medium text-[#F5F2ED] mb-[24px]">Launch Protocol</h3>
                      <div className="flex flex-col gap-[16px]">
                        {[
                          ...
                          <div key={i} className="flex items-center gap-[12px]">
                            ...
                            <span className="font-sans text-[14px] font-normal text-[#F5F2ED]/[0.65] leading-none mt-1">
                              {item.label}
                            </span>
                          </div>
                        ))}
            ...
            {/* PHASE 06: EVOLVE */}
            <PhaseAtmosphere id="evolve" number="06" className="scroll-mt-[96px] mt-[40px]">
              <div className="w-full h-px bg-[linear-gradient(90deg,transparent_10%,rgba(201,166,107,0.06)_50%,transparent_90%)] mb-[80px]" />
              <Container className="pb-[120px]">
                ...
                <FadeUp delay={0.1} className="pl-0 md:pl-[120px]">
                  ...
                  <h2 className="font-sans text-[40px] font-bold tracking-[-0.03em] text-[#F5F2ED] mt-[8px]">Evolve</h2>
                  <p className="font-sans text-[18px] font-normal italic text-[#F5F2ED]/[0.50] mt-[8px]">The launch is just the baseline.</p>
                </FadeUp>
                ...
                <div className="mt-[40px] pl-0 md:pl-[120px] flex flex-col md:flex-row gap-[48px]">
                  ...
                  <ScrollReveal delay={0.4} className="flex-1 flex flex-col gap-[16px]">
                    {[
                      ...
                      <div key={i} className="flex items-start gap-[16px] p-[20px] rounded-[12px] bg-[#F5F2ED]/[0.02] border border-[#F5F2ED]/[0.06]">
                        <div className="w-[8px] h-[8px] rounded-full bg-accent-base/50 shrink-0 mt-[6px]" />
                        <div>
                          <h4 className="font-sans text-[14px] font-medium text-[#F5F2ED] mb-[4px]">{tier.title}</h4>
                          <p className="font-sans text-[13px] font-normal text-[#F5F2ED]/[0.55] leading-[1.6]">{tier.desc}</p>
                        </div>
                      </div>
                    ))}
                  </ScrollReveal>
                ...
                <FadeUp delay={0.5} className="mt-[40px] pl-0 md:pl-[120px]">
                  <div className="w-full flex flex-col md:flex-row divide-y md:divide-y-0 md:divide-x divide-white/[0.06] bg-[#F5F2ED]/[0.01] rounded-[24px] border border-white/[0.06] overflow-hidden">
                    {[
                      ...
                      <div key={i} className="flex-1 p-[24px] flex flex-col items-center justify-center text-center">
                        <Meta className="mb-[8px] text-[#F5F2ED]/[0.35]">{stat.label}</Meta>
                        <span className="font-sans text-[18px] font-medium text-[#F5F2ED]">{stat.value}</span>
                      </div>
                    ))}
                  </div>
                </FadeUp>
